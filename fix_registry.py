...
content = content.replace("manager = DeviceControlManager(DeviceRegistry(RegistryAuthorityToken()), capacity_releaser=store.record_operation_terminated)", device_mock_code.strip())
