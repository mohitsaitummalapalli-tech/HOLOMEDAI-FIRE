# -*- coding: utf-8 -*-
"""Test Fixtures for M09 Persistence Test Suite."""
...
def temp_storage_root(tmp_path: Path) -> Path:
    """Provide an isolated temporary directory for test journal storage."""
...
def secret_filter() -> SecretFilter:
    return SecretFilter(secrets=["TOP_SECRET_PERSISTENCE_TOKEN"])
