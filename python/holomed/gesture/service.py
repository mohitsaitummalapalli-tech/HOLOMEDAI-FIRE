...
class GestureService(IService):
    ...
    def ingest_observation(
        ...
        try:
            ...
            session_key = (effective_session_id, stamped_obs.device_id, stamped_obs.physical_id, stamped_obs.epoch_id)
            ...
            tracker, state_machine, pipeline = self._get_session_components(effective_session_id)
    ...
    def purge_session(self, session_id: str) -> None:
        ...
        self._emit_event("gesture.session.purged", {"session_id": session_id, "epoch_id": self._epoch_id})
