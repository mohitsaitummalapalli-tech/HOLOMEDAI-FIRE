...
class AudioService(IService):
    ...
    def ingest_chunk(
        ...
        effective_session_id = session_id or chunk.session_id or self._default_session_id



        if session_id is not None and chunk.session_id is not None and session_id != chunk.session_id:
