...
class CommandState(str, enum.Enum):
    ...
    # Authoritative Terminal Resolutions (M49.3.5 Phase 2)
    OPERATION_COMPLETED = "OPERATION_COMPLETED"
    OPERATION_ABORTED_AND_QUIESCENT = "OPERATION_ABORTED_AND_QUIESCENT"
    OPERATION_CONFIRMED_ABSENT = "OPERATION_CONFIRMED_ABSENT"
