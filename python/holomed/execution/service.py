...
class NavigationExecutionService(IService):
    """Canonical Navigation Safety Gate Execution Enforcement & Coordination Gateway."""
    ...
    def execute_navigation(self, request: NavigationExecutionRequest) -> NavigationExecutionResult:
        ...
        try:
            ...
            try:
                self._navigation_service.submit_pose(request.pose)
